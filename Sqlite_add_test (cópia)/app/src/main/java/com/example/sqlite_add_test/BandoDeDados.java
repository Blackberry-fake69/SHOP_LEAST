...
public class BandoDeDados extends SQLiteOpenHelper {
    ...
    public static final String Tabelatwo = "Consulta";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String criandotabletwo =

                "CREATE TABLE " + Tabelatwo +
                        " (" + Colunaid + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                        Colunaproduto + " TEXT, " +
                        Colunapreco + " DECIMAL); ";

        db.execSQL(criandotabletwo);
    ...
    public void onUpgrade(SQLiteDatabase db, int anterior, int atual) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + Tabelatwo);
   ...
   /* public boolean Confirmacao(boolean confirma){
    ...
    Cursor LerTodoBancotwo(){
        String selecionatudodatabela = "SELECT * FROM " + Tabelatwo;
